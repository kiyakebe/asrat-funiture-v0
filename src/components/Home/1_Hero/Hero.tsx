...
const Hero = () => {
  return (
    <div className={` ${style.hero_slide_container}`}>
      <div className={style.stop_space}></div>
      <div className={`container-lg px-3 h-100 `}>
        ...
        <div className="row h-100 flex-lg-row-reverse align-items-center">
          ...
          <div className={`col-lg-6 ${style.hero_description}`}>
            <h2 className={`mb-3 ${style.lead_head}`}>
            ...
            <button type="button" className={` ${style.hero_ripple} `}>
              Go Shopping
            </button>
          </div>
        </div>
